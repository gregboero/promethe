...
class HarnessKotlinRunner(
    ...
    fun compatibilityKey(): String =
        "kotlin-adaptation-v1:${System.getProperty("os.name")}:${System.getProperty("os.arch")}:" +
            KotlinRuntimePreparation(distribution, javaRuntime, scratchRoot, true).sourceFingerprint()
